...
find ./NEWMODULE -type f -exec sed -i "s|PYRAMID|${MODULENAME}|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|MOD_PYRAMID_|MOD_${MODULENAME}_|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|pyramid|${LMODULENAME}|g" {} \;
printf "enter the year, your name and email address on one line for the copyright notice. eg 2015 John Doe jdoe@email.com \n" 
read 2020 Tom Mueller
find ./NEWMODULE -type f -exec sed -i "s|2020 Tom Mueller|${2020 Tom Mueller}_|g" {} \; 
