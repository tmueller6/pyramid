...
class mod_pyramid_edit_form extends moodleform
{
    ...
    public function definition()
    {
        ...
        if(($this->_customdata['pyramid_phase'] == 20) && ($this->_customdata['grpcount'] > 2)){
            $this->_form->addElement('textarea', 'text3', 'Text 3', array(
                'readonly' => 'true',
                'rows' => '10',
                'cols' => '180'
            ));
