...
/**
 * Event observer for pyramid plugin
 *
 * @package    mod_pyramid
 * @copyright  2020 Tom Mueller
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 namespace mod_pyramid;
...
/**
 * Event observer for mod_pyramid
 *
 * @package    mod_pyramid
 * @copyright  2020 Tom Mueller
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class event_observer{
    ...
    public static function course_deleted(\core\event\course_deleted $event) {
       global $DB;
		//MOD_PYRAMID_TABLE should be deleted elsewhere
		...
		$ret = $DB->delete_records(MOD_PYRAMID_USERTABLE,array('courseid'=>$event->objectid));
		return $ret;
	}
}
